...
include("db.php"); //We include the database_connect.php which has the data for the connection to the database
...
mysqli_query($conn,"UPDATE ESP SET $column = '{$value}' WHERE id=$unit");
